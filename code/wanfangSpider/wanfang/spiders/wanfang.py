...
class WanfangSpider(scrapy.Spider):
    ...
    start_urls = [
        #'http://s.wanfangdata.com.cn/Paper.aspx?q=病+癌+肿瘤&f=top&p=1',
        'http://s.wanfangdata.com.cn/Paper.aspx?q=药&f=top&p=1',
    ]
    ...
    def parse_page(self, response):
        ...
        C_abstract = head.xpath("//div[@class='baseinfo-feild abstract']/div[@class='row clear zh']/div[@class='text']/text()").extract()
        E_abstract = head.xpath("//div[@class='baseinfo-feild abstract']/div[@class='row clear fl']/div[@class='text']/text()").extract()
